$(document).ready(function () {
    ...
    /*rating system*/
    $('.star').hover(function () {
        // mouseenter: Pintamos esta estrella y todas las anteriores    
        // Seleccionamos el <li> actual y todos sus hermanos anteriores
        $(this).prevAll('.star').addBack().find('i')
            .removeClass('bi-star')
            .addClass('bi-star-fill');
    }, function () {
        // mouseleave: Quitamos el relleno a todos
        // (Opcional: aquí deberías volver al estado real de la calificación guardada)
